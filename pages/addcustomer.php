...
<head>
  ...
  <title>
    Adicionar Cliente - NX Web Manager
  </title>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Adicione um novo cliente à base de dados.</p>
                </div>
                <div class="card-body">
                  <form method="post" action="addcustomer_sql.php" autocomplete="off">
                    <div class="row">
                      <div class="col-md-9">
