...
<head>
  ...
  <title>
    Reportar Problemas - NX Web Manager
  </title>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class="card-title ">Reportar erros / Pedidos manuais</h4>
                  <p class="card-category">Aqui pode reportar erros ou pedir alterações manuais como trocar fotografias ou remover viaturas.</p>
                </div>
                <div class="card-body">
                  ...
                  <button type="submit" class="btn btn-danger pull-right">Submeter</button>
                    </form>
                </div>
              </div>
            </div>
