...
<body class="">
  ...
  <div class="sidebar" data-color="purple" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
    ...
    <div class="main-panel">
      ...
      <!-- End Navbar -->
<div class="content">
  <h4 class="card-title" style="text-align: center">As viaturas nesta página estão dispostas pela ordem do WebSite.<br>Selecione a viatura que está vendida.</h4>
        <div class="container-fluid">
<?php
...
//Seleção da dB
$query = 'SELECT DISTINCT primary_id,img1,brand,model from stock INNER JOIN car_images ON stock.primary_id = car_images.car_id WHERE sold = "Nao" ORDER BY orderid ASC ;';
...
while ( $row = mysqli_fetch_array($rs) ) {
  ...
  echo ' 
          ...
          <div class="card" >
            ...
            <form method="GET" action="sold_sql.php">
            <input type="hidden" name="c_id" value="'.$row['primary_id'].'"> 
            <button class="btn btn-primary btn-round" style="">Selecionar</button>            
            </form>
                </div>
              </div>
              </div>
