...
<head>
  ...
  <title>
    Associar Cliente - NX Web Manager
  </title>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Associar venda a um cliente</h4>
                  <p class="card-category">Escolha o cliente a que vendeu a viatura.</p>
...
<?php
  ...
  while ($result = mysqli_fetch_array($rs)) {
    echo '<tr> <!--tr é row/linha-->
                        ...
                        echo'</td>
                        <td>
                        <form action="associate_sql.php" method="GET"><input type="hidden" name="customer_id" value="'.$result["primary_id"].'"><button class="btn btn-info" type="submit">Associar</button></form>
                        </td>
                     </tr>';
